...
_G.packer_plugins = {
  ...
  ["palenight.vim"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/palenight.vim",
  ...
  ["vim-colorschemes"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-colorschemes",
  ...
  ["vim-substrata"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-substrata",
